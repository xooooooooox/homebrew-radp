...
#
# Placeholders:
#   https://github.com/xooooooooox/radp-bash-framework/archive/refs/tags/v0.6.22.tar.gz - GitHub archive URL for the release tag
#   c3f7da7af2b296ca81be3d62a90bf6de0a5e0e73f7833feb639ed3b834c259ba      - SHA256 checksum of the tarball
#   0.6.22     - Version number (without 'v' prefix)
#
# Installation:
...
class RadpBashFramework < Formula
  ...
  url "https://github.com/xooooooooox/radp-bash-framework/archive/refs/tags/v0.6.22.tar.gz"
  sha256 "c3f7da7af2b296ca81be3d62a90bf6de0a5e0e73f7833feb639ed3b834c259ba"
  version "0.6.22"
  license "MIT"
